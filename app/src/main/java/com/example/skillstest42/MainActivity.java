...
//        listView.setOnItemClickListener(this);
        ...
        //
        studidno = (EditText) findViewById(R.id.studidno);
...
//        localhostDialog();
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.btnlogin:
                new AsyncLogin().execute(studidno.getText().toString());
                break;
        }
    }
    ...
    private class AsyncLogin extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                url = new URL("http://192.168.254.112/skillstest42/loginstudent.php");
            } catch (Exception e) {
                e.printStackTrace();
                return "exception";
            }
        ...
        protected void onPostExecute(String result) {
            if (result.equalsIgnoreCase("true")) {
                ...
                Toast.makeText(MainActivity.this, "ID number does not exist in the database!", Toast.LENGTH_SHORT).show();
